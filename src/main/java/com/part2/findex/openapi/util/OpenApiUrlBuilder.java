...
public final class OpenApiUrlBuilder {
    ...
    public static String buildUrl(StockIndexRequestParam param) throws UnsupportedEncodingException {
        ...
        if (param.getIdxNm() != null)
            builder.queryParam("idxNm", URLEncoder.encode(param.getIdxNm(), StandardCharsets.UTF_8));
        ...
        if (param.getBeginLstgMrktTotAmt() != null)
            builder.queryParam("beginLstgMrktTotAmt", param.getBeginLstgMrktTotAmt());
        if (param.getEndLstgMrktTotAmt() != null) builder.queryParam("endLstgMrktTotAmt", param.getEndLstgMrktTotAmt());
        if (param.getBeginLsYrEdVsFltRg() != null)
            builder.queryParam("beginLsYrEdVsFltRg", param.getBeginLsYrEdVsFltRg());
        if (param.getEndLsYrEdVsFltRg() != null) builder.queryParam("endLsYrEdVsFltRg", param.getEndLsYrEdVsFltRg());
        if (param.getBeginLsYrEdVsFltRt() != null)
            builder.queryParam("beginLsYrEdVsFltRt", param.getBeginLsYrEdVsFltRt());
